...
xmlhttp.open("GET","insert_data.php?name="+name+"&key=route",true);
xmlhttp.send();
}

function delete_route(str)
{
	
	var result=confirm("Do you really want to delete this Route?");
if(result)
{
if (window.XMLHttpRequest)
...
xmlhttp.open("GET","insert_data.php?busid="+str+"&key=delroute",true);
xmlhttp.send();
}
}
        </script>
